...
```
export MINIO_ACCESS_KEY=`helm get values swoop-caboose -a -o json | jq -r .service.accessKeyId | base64 --decode`
export MINIO_SECRET_KEY=`helm get values swoop-caboose -a -o json | jq -r .service.secretAccessKey | base64 --decode`
